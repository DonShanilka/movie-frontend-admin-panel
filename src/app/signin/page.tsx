...
export default function SignInPage() {
    ...
    return (
        <div className="min-h-screen w-full flex items-center justify-center bg-zinc-950 relative overflow-hidden">
            ...
            <div className="absolute top-0 -left-4 w-72 h-72 bg-yellow-400/10 rounded-full blur-[128px] animate-pulse" />
            <div className="absolute bottom-0 -right-4 w-72 h-72 bg-indigo-500/10 rounded-full blur-[128px] animate-pulse delay-700" />
            ...
            <div className="w-full max-w-md p-8 relative z-10">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                        <div className="flex items-center justify-between ml-1">
                            ...
                            <Link href="#" className="text-xs text-yellow-400 hover:text-yellow-300 transition-colors">
                                Forgot password?
                            </Link>
                        </div>
                        <div className="relative group">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-yellow-400 hover:bg-yellow-500 disabled:opacity-50 disabled:cursor-not-allowed text-black font-bold py-4 rounded-2xl shadow-xl shadow-yellow-400/10 transition-all active:scale-[0.98] flex items-center justify-center gap-2 group"
                    >
                        {loading ? (
                ...
                <p className="text-center text-zinc-400 mt-10 text-sm">
                    ...
                    <Link href="/signup" className="text-yellow-400 font-semibold hover:underline decoration-2 underline-offset-4">
                        Create an account
                    </Link>
                </p>
            </div>
